class ComposerAT22 < Formula
  ...
  def install
    libexec.install "composer.phar" => "composer@2.2"
    (libexec/"composer@2.2").chmod 0755
    (bin/"composer@2.2").write_env_script libexec/"composer@2.2", COMPOSER_HOME: "~/.composer@2.2"
  end
  ...
  test do
    ...
    system "#{bin}/composer@2.2", "install"
